...
public class Maze {
	...
	// Vars for use with the code pertaining to reading maze data from a file, and
	// processing it
	...
	/**
	 * readFile() takes in a String, which is the name of a file and reads the data
	 * from that file into mazeSize and mazeData
	 * 
	 * @param filename
	 *            - Name of file
	 * @throws IOException
	 ...
	 * maze, and runs the diagnostic method to see if the maze is good. found from U
	 * washington test bench code and edited to fit our purpose
	 */
	public static void main(String[] args) {
		...
		if (args.length != 0) {
			...
			// System.out.println("---------------------Print metadata during
			// testing.---------------------");
			...
			System.out.print("Please enter the horizontal size of maze: ");
			int x = Integer.parseInt(input.nextLine());
			System.out.print("Please enter the verticle size of maze: ");
